...
= 如何申请接口许可凭证? =
* 支付宝:请访问`支付宝官方网站`-`商家服务`-`即时到帐`进行申请.[传送门](https://b.alipay.com/index.htm)
...
= Version 3.5.8 (2012-07-18) =
* 修复了在子目录建站后台无法保存设置的BUG
* 修复了权限验证方法
...
= Version 1.3.5 (2012-01-06) =
* 修复了linux主机下模版读取JSON格式错误

= Version 1.3.4 (2012-01-06) =
* 修复了边栏自助广告脚本BUG

= Version 1.3.3 (2012-01-05) =
* 修复了已知BUG

= Version 1.3.2 (2012-01-05) =
* 该插件的第一个公测版本
