 ...
 */
class WSAlipay_Products_List_Table extends WP_List_Table {
    ...
    function __construct(){
        ...
        parent::__construct( array(
            'singular'  => '商品',     //singular name of the listed records
            'plural'    => '商品',    //plural name of the listed records
     ...
     **************************************************************************/
        ...
        //Build row actions
        $actions = array(
            'edit'      => sprintf('<a href="?page=%s&action=%s&proid=%s">编辑</a>',$_REQUEST['page'],'edit',$item['ID']),
...
global $wpdb;
$data = $wpdb->get_results("SELECT *,`name`as`title`,`proid`as`ID`,CONCAT('[zfb id=',proid,']')as`shortcode` FROM `{$wpdb->wsaliproducts}`;", ARRAY_A);


//$count = $wpdb->get_var("SELECT COUNT(*) FROM `{$wpdb->wsaliproducts}`;");
//die($count );
