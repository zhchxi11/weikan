...
function ws_alipay_init() {
	...
	wp_register_script('ws_alipay_front_js', 
	WS_ALIPAY_URL . '/javascripts/front.js',array('jquery') );
	wp_enqueue_script('ws_alipay_front_js');
	
	wp_register_script('ws_alipay_widget_js',
...
function ws_alipay_validateFormat($value, $type){
	...
	switch( strtoupper($type) ){
		...
		case 'URL';
			...
			break;
		case 'TEL':
			return preg_match("/^1(30|31|32|45|55|56|85|86|34|35|36|37|38|39|47|50|51|52|57|58|59|82|83|87|88|33|53|89|80
)[0-9]{8}$/", $value );
			break;	
		case 'POSTCODE':
